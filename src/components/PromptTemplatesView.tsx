  ...
  const templates = [
    {
      ...
      description: "Formula ini berfokus pada hook masalah dalam 2 detik pertama, diikuti pembuktian klaim manfaat secara langsung secara visual kasar (lifestyle), dan diakhiri CTA cek keranjang kuning.",
